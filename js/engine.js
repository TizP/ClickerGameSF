...
// Import UI function for button update on deactivate
...
export function calculateDerivedStats() {
    ...
    // (Keep Production Boost logic unchanged)
    ...
    // (Keep Money Per Second calculation unchanged)
    ...
    // (Keep Final Rate Assignment unchanged)
